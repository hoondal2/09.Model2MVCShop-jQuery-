...
function fncGetProductList(currentPage){
	...
	$("form").attr("method" , "POST").attr("action" , "/prouct/listProduct?menu=manage").submit();
	
	$(function() {
		$( "td.pp" ).on("click" , function() {
...
function fncGetProductList(currentPage){
	...
	$("#currentPage").val(currentPage)
	//document.detailForm.action='/product/listProduct?menu=manage';
	$("form").attr("method" , "POST").attr("action" , "/prouct/listProduct?menu=search").submit();
